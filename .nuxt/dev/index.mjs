...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///Users/joey/Projects/collection/node_modules/h3/dist/index.mjs';
import mongoose from 'file:///Users/joey/Projects/collection/node_modules/mongoose/index.js';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/joey/Projects/collection/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/joey/Projects/collection/node_modules/devalue/index.js';
import destr from 'file:///Users/joey/Projects/collection/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash } from 'file:///Users/joey/Projects/collection/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/joey/Projects/collection/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Users/joey/Projects/collection/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/joey/Projects/collection/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/joey/Projects/collection/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/joey/Projects/collection/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/joey/Projects/collection/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/joey/Projects/collection/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/joey/Projects/collection/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/joey/Projects/collection/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Users/joey/Projects/collection/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/joey/Projects/collection/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/joey/Projects/collection/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/joey/Projects/collection/node_modules/consola/dist/index.mjs';
import devalue from 'file:///Users/joey/Projects/collection/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { getContext } from 'file:///Users/joey/Projects/collection/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file:///Users/joey/Projects/collection/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/joey/Projects/collection/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/joey/Projects/collection/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "API_URL": "",
    "IGDB_CLIENT_ID": "s3ayyh2qwaonaytfnkjw7pqe25hk93",
    "IGDB_CLIENT_SECRET": "di8a3het9e2uvn5gw63g3og49imykf",
    "PROXY": "https://collectionproxy.onrender.com/"
  },
  "mongoUri": "mongodb+srv://Qoncrete:Mongo123!@cluster.xgesh.mongodb.net/collection?"
};
const envOptions = {
  prefix: "NITRO_",
...
const serverAssets = [{"baseName":"server","dir":"/Users/joey/Projects/collection/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/joey/Projects/collection","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/joey/Projects/collection/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/joey/Projects/collection/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/joey/Projects/collection/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/joey/Projects/collection/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _hhSkhg8PAr = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/joey/Projects/collection";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _3QS49Xm8Jc = (nitroApp) => {
...
const _FFSHXjCLPy = async (nitroApp) => {
  try {
...
const _lazy_8BWoue = () => Promise.resolve().then(function () { return _id__delete$1; });
const _lazy_VUVqIS = () => Promise.resolve().then(function () { return _id__put$1; });
const _lazy_Cz3hHJ = () => Promise.resolve().then(function () { return index_get$1; });
const _lazy_geT8r2 = () => Promise.resolve().then(function () { return index_post$1; });
const _lazy_LuOtBF = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/games/:id', handler: _lazy_8BWoue, lazy: true, middleware: false, method: "delete" },
  { route: '/api/games/:id', handler: _lazy_VUVqIS, lazy: true, middleware: false, method: "put" },
  { route: '/api/games', handler: _lazy_Cz3hHJ, lazy: true, middleware: false, method: "get" },
  { route: '/api/games', handler: _lazy_geT8r2, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_LuOtBF, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_LuOtBF, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Users/joey/Projects/collection/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/joey/Projects/collection/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
