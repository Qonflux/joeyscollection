...
import { getCurrentInstance, reactive, toRef, isRef, inject, defineComponent, computed, ref, h, resolveComponent, version, nextTick, shallowRef, useSSRContext, mergeProps, Suspense, Transition, provide, defineAsyncComponent, onErrorCaptured, unref, createApp } from "vue";
...
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderComponent, ssrRenderSuspense } from "vue/server-renderer";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/index.746fff37.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index.f9715dff.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index.3dfd8e8d.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index.0add5507.js").then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.932b7b72.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
