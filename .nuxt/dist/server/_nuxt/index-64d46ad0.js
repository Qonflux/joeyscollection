import { useSSRContext, mergeProps, ref, unref, reactive } from "vue";
...
import "defu";
const LoadingSpinner_vue_vue_type_style_index_0_lang = "";
const _sfc_main$2 = {
  props: {
    size: {
      type: [Number, String],
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_AdminGameDetail = _sfc_main$1;
...
//# sourceMappingURL=index-64d46ad0.js.map
