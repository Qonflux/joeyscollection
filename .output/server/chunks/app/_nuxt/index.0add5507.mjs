...
import { useSSRContext, withAsyncContext, ref, computed, resolveComponent, unref, withCtx, createVNode, reactive, watch, nextTick, mergeProps, createTextVNode, toDisplayString } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderTeleport, ssrRenderStyle, ssrIncludeBooleanAttr, ssrLooseContain, ssrRenderSlot } from 'vue/server-renderer';
import { u as useFetch } from './fetch.84a74b64.mjs';
...
const actions = {
  ...
  async getAllGames() {
    ...
    const { data: games } = await useFetch(`${baseUrl}/api/games`, "$IGrTh3Q0c0");
    return games;
  },
  async removeFilters() {
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-6d06d5d9"]]);
const _sfc_main$2 = {
...
const _sfc_main$1 = {
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_GamesPaginationButton = _sfc_main$2;
      ...
      _push(ssrRenderComponent(_component_GamesPaginationButton, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_font_awesome_icon, { icon: "fa-solid fa-angle-left" }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_component_font_awesome_icon, { icon: "fa-solid fa-angle-left" })
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_GamesPaginationButton, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_font_awesome_icon, { icon: "fa-solid fa-angle-right" }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_component_font_awesome_icon, { icon: "fa-solid fa-angle-right" })
            ];
          }
        }),
        _: 1
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b;
      const _component_FilterOverlay = __nuxt_component_0;
      const _component_font_awesome_layers = resolveComponent("font-awesome-layers");
      const _component_font_awesome_icon = resolveComponent("font-awesome-icon");
      const _component_GamesPagination = _sfc_main$1;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-427daf73>`);
      ...
      _push(`<div class="flex justify-between text-sm mb-3" data-v-427daf73><div class="text-gray-500" data-v-427daf73>${ssrInterpolate((_a = unref(gameStore).games) == null ? void 0 : _a.length)} game`);
      if (((_b = unref(gameStore).games) == null ? void 0 : _b.length) > 1) {
        _push(`<span data-v-427daf73>s</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><p data-v-427daf73> Sorteren: <span class="text-gray-500 cursor-pointer" data-v-427daf73>${ssrInterpolate(unref(sortingValue))}</span>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_font_awesome_icon, {
              icon: "sort-down",
              class: { "text-gray-500": unref(isSortedUp) }
      ...
      _push(`</p><p class="text-violet-500 cursor-pointer" data-v-427daf73><span data-v-427daf73>`);
      _push(ssrRenderComponent(_component_font_awesome_icon, { icon: "fa-solid fa-filter" }, null, _parent));
      _push(` Filters</span>`);
      ...
      _push(`</p></div><div class="grid grid-cols-12 gap-4 mb-1" data-v-427daf73><!--[-->`);
      ssrRenderList(unref(gamesArray).slice(unref(page) * unref(numPerPage), unref(page) * unref(numPerPage) + unref(numPerPage)), (game) => {
        _push(`<div id="game" class="col-span-6 sm:col-span-4 lg:col-span-3 xl:col-span-2 relative" data-v-427daf73><img${ssrRenderAttr("src", game.cover)} class="mx-auto rounded-md transition duration-200 border-2 border-gray-700 h-full" data-v-427daf73><div class="info absolute top-4 left-0 opacity-0 transition duration-200 w-full" data-v-427daf73><h3 class="text-center" data-v-427daf73>${ssrInterpolate(game.name)}</h3><p class="text-center mt-3" data-v-427daf73>Release: ${ssrInterpolate(game.releaseDate)}</p><p class="text-center mt-3" data-v-427daf73>Platform: <img${ssrRenderAttr("src", getImage(game.platform))} class="inline" data-v-427daf73></p><p class="text-center mt-3" data-v-427daf73> Uitgespeeld: `);
        _push(ssrRenderComponent(_component_font_awesome_icon, {
          icon: `fa-solid fa-${game.completed ? "check-circle" : "circle-xmark"}`,
          class: game.completed ? "text-green-500" : "text-red-500"
        }, null, _parent));
        _push(`</p></div><div class="info absolute bottom-2 left-2 opacity-0 transition duration-200 text-xxs flex gap-2 flex-wrap" data-v-427daf73><!--[-->`);
        ssrRenderList(game.genres, (genre) => {
          _push(`<div class="bg-violet-600 pt-1 pb-0.5 px-2 rounded-full" data-v-427daf73>${ssrInterpolate(genre)}</div>`);
        });
        _push(`<!--]--></div></div>`);
      });
      _push(`<!--]--></div>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-427daf73"]]);

export { index as default };
//# sourceMappingURL=index.0add5507.mjs.map
