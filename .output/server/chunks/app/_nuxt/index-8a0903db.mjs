import { d as defineStore, _ as _export_sfc, a as useNuxtApp, u as useRuntimeConfig } from '../server.mjs';
...
import { u as useFetch } from './fetch-6fe412f8.mjs';
import 'ofetch';
import 'hookable';
import 'unctx';
import 'ufo';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-cbf808a0>`);
      ...
      _push(`<div class="flex justify-between text-sm mb-3" data-v-cbf808a0><div class="text-gray-500" data-v-cbf808a0>${ssrInterpolate((_a = unref(gameStore).games) == null ? void 0 : _a.length)} game`);
      if (((_b = unref(gameStore).games) == null ? void 0 : _b.length) > 1) {
        _push(`<span data-v-cbf808a0>s</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><p class="flex gap-1 items-center" data-v-cbf808a0> Sorteren: <span class="text-gray-500 cursor-pointer" data-v-cbf808a0>${ssrInterpolate(unref(sortingValue))}</span>`);
      ...
      _push(`</p><div class="flex gap-1 items-center" data-v-cbf808a0><p class="text-violet-500 cursor-pointer flex gap-1 items-center" data-v-cbf808a0>`);
      _push(ssrRenderComponent(_component_font_awesome_icon, {
        icon: "fa-solid fa-filter",
        class: "h-4 w-4"
      }, null, _parent));
      _push(` <span data-v-cbf808a0>Filters</span></p>`);
      ...
      _push(`</div></div><div class="grid grid-cols-12 gap-4 mb-1" data-v-cbf808a0><!--[-->`);
      ssrRenderList(unref(gamesArray).slice(unref(page) * unref(numPerPage), unref(page) * unref(numPerPage) + unref(numPerPage)), (game) => {
        _push(`<div id="game" class="col-span-6 sm:col-span-4 lg:col-span-3 xl:col-span-2 relative" data-v-cbf808a0><img${ssrRenderAttr("src", game.cover)} class="mx-auto rounded-md transition duration-200 border-2 border-gray-700 h-full" data-v-cbf808a0><div class="info absolute top-4 left-0 opacity-0 transition duration-200 w-full" data-v-cbf808a0><h3 class="text-center" data-v-cbf808a0>${ssrInterpolate(game.name)}</h3><p class="text-center mt-3" data-v-cbf808a0>Release: ${ssrInterpolate(game.releaseDate)}</p><p class="text-center mt-3" data-v-cbf808a0>Platform: <img${ssrRenderAttr("src", getImage(game.platform))} class="inline" data-v-cbf808a0></p><p class="text-center mt-3 flex gap-1 items-center justify-center" data-v-cbf808a0><span data-v-cbf808a0>Uitgespeeld:</span>`);
        _push(ssrRenderComponent(_component_font_awesome_icon, {
          icon: `fa-solid fa-${game.completed ? "check-circle" : "circle-xmark"}`,
          class: ["w-4 h-4", game.completed ? "text-green-500" : "text-red-500"]
        }, null, _parent));
        _push(`</p></div><div class="info absolute bottom-2 left-2 opacity-0 transition duration-200 text-xxs flex gap-2 flex-wrap" data-v-cbf808a0><!--[-->`);
        ssrRenderList(game.genres, (genre) => {
          _push(`<div class="bg-violet-600 pt-1 pb-0.5 px-2 rounded-full" data-v-cbf808a0>${ssrInterpolate(genre)}</div>`);
        });
        _push(`<!--]--></div></div>`);
      });
      _push(`<!--]--></div>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cbf808a0"]]);

export { index as default };
//# sourceMappingURL=index-8a0903db.mjs.map
